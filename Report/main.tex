...
% ---------------------------
\input{sections/01-background-and-objectives}
\input{sections/02-methodology-and-concepts}
\input{sections/03-experimental-setup-and-test-cases}
\input{sections/04-analysis-and-findings}
...
% Bibliography
% ----------------------------------------
\nocite{*} % Include all references from the .bib file % TODO: remove and cite the bib refs in the text
