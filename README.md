...
This repository contains the Lab Material and the LaTeX source files for the Lab WiFi for the **Wireless and Device-to-Device Communication Security** course.
